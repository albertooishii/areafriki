    ...
    FullScreenMario.FullScreenMario.settings.ui = {
        ...
        "styleSheet": {
            ...
            "@font-face": {
                ...
                "src": [
                    "url('vendor/FullScreenMario/Fonts/pressstart2p-webfont.eot')",
                    "url(''vendor/FullScreenMario/Fonts/pressstart2p-webfont.eot?#iefix') format('embedded-opentype')",
                    "url(''vendor/FullScreenMario/Fonts/pressstart2p-webfont.woff') format('woff')",
                    "url(''vendor/FullScreenMario/Fonts/pressstart2p-webfont.ttf') format('truetype')",
                    "url(''vendor/FullScreenMario/Fonts/pressstart2p-webfont.svg') format('svg')"
                ].join(", "),
                "font-weight": "normal",
                "font-style": "normal"
            }
