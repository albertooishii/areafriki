<div class="container wrapper">
    <h2 class="subhead">POLÍTICA DE COOKIES</h2>

    <h4 class="subhead">INFORMACIÓN</h4>
    ...
    Sin su expreso consentimiento –mediante la activación de las cookies en su navegador–<?=PAGE_DOMAIN?> no enlazará en las cookies los datos memorizados con sus datos personales proporcionados en el momento del registro o la compra..

    <h4 class="subhead">COOKIES UTILIZADAS</h4>
    ...
    <h4 class="subhead">INHABILITAR LAS COOKIES</h4>
    ...
    <ul>
        ...
        <li><a href="http://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-que-los-sitios-web">Firefox</a></li>
        <li><a href="http://support.apple.com/kb/ph5042">Safari</a></li>
    </ul>

    <p>Si tiene dudas sobre esta política de cookies, puede contactar con <?=PAGE_NAME?> en <a href="mailto:<?=SUPPORT_EMAIL?>"><?=SUPPORT_EMAIL?></a></p>

    <h4 class="subhead">COOKIES UTILIZADAS</h4>

    <p>Cookies propias (desde el dominio <?=PAGE_DOMAIN?>):</p>
    <ul>
        <li>pass</li>
        <li>user</li>
        <li>PHPSESSID</li>
