...
<div class="page-header header-filter" data-parallax="active" style="background-image: url(<?=PAGE_DOMAIN?>/app/views/info/registro_crafter_bg.jpg); transform: translate3d(0px, 0px, 0px);">
    <div class="container wrapper">
        <div class="row">
            <div class="col-md-7">
                <h1 class="title">¿Haces manualidades?</h1>
                <h4>Ahora puedes vender tus artículos hechos a mano en <?=PAGE_NAME?>: hama, lana, papercraft, cosplays, goma eva, peluches, impresión 3D.... Marca cuanto quieres ganar por cada venta · Totalmente gratis, sin comisiones adicionales.</h4>
                <br>
                <iframe width="100%" height="340" src="https://www.youtube.com/embed/1GL36EzFHlQ" frameborder="0" allowfullscreen class="nomobile notablet"></iframe>
            </div>
            <div class="col-md-5">
                <form id="registrationForm" method="post" style="background-color:white; padding:25px; border-radius:3px;" action="/register"
                    ...
                    <input type="hidden" name="redirect" value="<?=PAGE_DOMAIN?>/upload/crafts">
