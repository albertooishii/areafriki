...
<div class="col-md-5" id="design-info">
    <div class="resumen">
        ...
        <div class="form-group">
            ...
            <input id="file" type="file" class="file" accept="application/pdf, image/x-eps, application/illustrator, application/postscript, image/svg+xml" name="design_editable" data-allowed-file-extensions='["ai", "pdf", "eps", "ps", "svg"]' data-show-preview=false data-show-remove=false data-show-upload=false data-language=es
