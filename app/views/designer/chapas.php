<div class="col-md-7 img-design">
    <header class="aligncenter"><h3>DISEÑA TU CHAPA</h3></header>
...
<div class="col-md-5" id="design-info">
   ...
   <div class="precio">
        ...
        <label>
            <p>Indica en el siguiente formulario el beneficio que quieres tener por cada pack de chapas vendido con este diseño. El precio final del producto se calculará automáticamente en el proceso de compra dependiendo de la cantidad elegida.</p>
       </label>
       <div class="form-group">
           <p>
