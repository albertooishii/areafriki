                  ...
                  <div id="stock" class="tab-pane fade">
                    ...
                    <div id="envio" class="tab-pane fade">
                        <div class="form-group">
                            ...
                            <p>Gastos de envío: <input type="number" class="form-control" id="gastos_envio" name="gastos_envio" min="0" max="200" step="0.05" value="0.00" style="width:150px; display:inline-block;"> €</p>
                    ...
                    <div id="precio" class="tab-pane fade">
                        <div class="form-group">
                            ...
                            <p>Precio de venta: <input type="number" class="form-control" id="precio" min="0" max="9999" step="0.05" value="0.00" style="width:150px; display:inline-block;"> €</p>
