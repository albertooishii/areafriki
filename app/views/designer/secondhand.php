<div class="container wrapper">
    ...
    <div class="row">
        <form id="fileupload" class="formvalidation" method="POST" enctype="multipart/form-data" data-id="<?=$data['dg-id-cat']?>">
            <div class="col-lg-6 col-md-12 col-sm-12 img-design">
                <label>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12" id="design-info">
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="tab" href="#stock"><i class="fa fa-cubes"></i><span class="text-tab nomobile">Cantidad</span></a></li>
