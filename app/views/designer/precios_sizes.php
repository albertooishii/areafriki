<div class="precios_sizes form-group">
    <p>
        ...
        <span class="beneficio">
            <label>Beneficio: </label><input type="number" step="0.01" min="0" max="<?=$data["beneficio_max"]?>" class="form-control" value="0.00"
        ...
        <input type="text" class="slider beneficio_range" name="beneficio[]" data-slider-min="0" data-slider-max="<?=$data["beneficio_max"]?>" data-slider-step="0.01" data-slider-value="0.00" style="padding-left:10px;" maxlength="4"
