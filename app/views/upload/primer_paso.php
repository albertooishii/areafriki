<div class="container wrapper">
    <header class="text-center">
        <h3 class="title">¿Qué quieres vender en tu tienda online?</h3>
...
<img src="/app/templates/frontoffice/img/layout/design.png" alt="Generic placeholder image" width="140px" height="140px">
                        ...
                        <button class="btn btn-primary btn-round">Subir mis Diseños</button>
                    </div>
                </a>
            </div>
        </div>
...
<img src="/app/templates/frontoffice/img/layout/baul.png" alt="Generic placeholder image">
                        ...
                        <button class="btn btn-primary btn-round">Vender mis productos</button>
                    </div>
                </a>
            </div>
        </div>
