<?php
    $data["page_title"]=$data["descripcion_corta"]." en la tienda friki de ".$data["username"];
    $data["descripcion"]="Productos de la categoría ".$data["descripcion_corta"]." en la tienda de ".$data["username"]." en ".PAGE_NAME.".";
?>
