$(document).ready(function() {
    ...
    var now = new Date ($("#promo").data('nowtime')).getTime();
    var end = new Date ($("#promo").data('endtime')).getTime();
    var x = setInterval(function() {
        ...
        if (distance > 0) {
            ...
            $("#promo-countdown").html("La oferta finaliza en " + (days ? days + "d " : "") + hours + "h " + minutes + "m " + seconds + "s");
        }
        now = now + 1000;
        }, 1000);
});
