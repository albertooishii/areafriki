<div class="container wrapper">
     <div class="row">
        <div class="col-sm-6">
            <a class="card card-raised" data-toggle="tab" href="#personal_information">
                <div class="content">
                    <i class="material-icons">contact_mail</i> DATOS PERSONALES
                </div>
            </a>
            <a class="card card-raised" data-toggle="tab" href="#cash_information">
                <div class="content">
                    <i class="material-icons">credit_card</i> INFORMACIÓN SOBRE VENTAS
                </div>
            </a>
            <a class="card card-raised" data-toggle="tab" href="#change_password">
                <div class="content">
