    ...
    <div id='contacto'>
        <div class="row">
            ...
            <section id='contact-options' class="col-md-12 aligncenter">
                <a href="#" class="well option" data-email="CONTACT_EMAIL">
                ...
                <a href="#" class="well option" data-email="ERROR_EMAIL">
                ...
                <a href="#" class="well option" data-email="SUPPORT_EMAIL">
            ...
            <section id='form-contacto' class="col-md-6 well" style="display:none">
                <h3 id="form-title" class="subhead aligncenter"></h3>
